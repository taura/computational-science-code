...
* 課題の評価には使わないが、不正な使い方をしていないかどうかの確認につかうことはあり得る。
* また、研究利用の許諾（任意）をしていただけると幸いです。
* 説明は[ホームページ](https://taura.github.io/computational-science/index.html#data_sharing)を参照

...
を, 差分法 (15_pde_fdm) でも CG法 (17_linalg/problems/00_cg) でもなく, **ニューラルネット (機械学習)** で解く。これが **物理情報ニューラルネット (PINN, Physics-Informed Neural Network)** の考え方である。**同じ問題を全く別の道具で解く**ことを体験する, 最上級の発展課題である。
...
- 同じ `-u''=f` を, 差分法 (15_pde_fdm) や CG法 (17_linalg/problems/00_cg) とは全く別の道具 (機械学習) で解いたことを味わってほしい。
